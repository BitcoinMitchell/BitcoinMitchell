...
- [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) ([v6.1.1](https://github.com/btcpayserver/prestashop-plugin/releases/tag/v6.1.1), 1 day ago) - Prestashop module for BTCPay Server payment integration
...
- [[Core] Resolve installation failure](https://github.com/btcpayserver/prestashop-plugin/pull/101) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (1 day ago)
- [Updated GitHub relevant files](https://github.com/btcpayserver/prestashop-plugin/pull/100) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (1 day ago)
- [Updated README/LICENSE to 2024](https://github.com/btcpayserver/prestashop-plugin/pull/99) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (1 day ago)
- [Prepare for module validation](https://github.com/btcpayserver/prestashop-plugin/pull/98) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (3 days ago)
- [Introduce order protection &#43; Improved processing of the webhook](https://github.com/btcpayserver/prestashop-plugin/pull/96) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (5 days ago)
