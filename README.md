...
- [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) ([v6.0.3](https://github.com/btcpayserver/prestashop-plugin/releases/tag/v6.0.3), 2 days ago) - Prestashop module for BTCPay Server payment integration
...
- [Prepare for module validation](https://github.com/btcpayserver/prestashop-plugin/pull/98) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (2 days ago)
- [Introduce order protection &#43; Improved processing of the webhook](https://github.com/btcpayserver/prestashop-plugin/pull/96) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (4 days ago)
- [Improved the configuration flow](https://github.com/btcpayserver/prestashop-plugin/pull/95) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (1 week ago)
