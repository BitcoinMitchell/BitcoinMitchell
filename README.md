...
- [btcpayserver/btcpayserver](https://github.com/btcpayserver/btcpayserver) - Accept Bitcoin payments. Free, open-source &amp; self-hosted, Bitcoin payment processor.  (6 days ago)
...
- [btcpayserver/btcpayserver](https://github.com/btcpayserver/btcpayserver) ([v1.12.5](https://github.com/btcpayserver/btcpayserver/releases/tag/v1.12.5), 2 weeks ago) - Accept Bitcoin payments. Free, open-source &amp; self-hosted, Bitcoin payment processor. 
- [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) ([v6.0.2](https://github.com/btcpayserver/prestashop-plugin/releases/tag/v6.0.2), 3 months ago) - Prestashop module for BTCPay Server payment integration
...
- [Draft: Introduce order protection &#43; Improved processing of the webhook](https://github.com/btcpayserver/prestashop-plugin/pull/96) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (2 days ago)
- [Improved the configuration flow](https://github.com/btcpayserver/prestashop-plugin/pull/95) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (5 days ago)
- [Update GeneralSettings.cshtml](https://github.com/btcpayserver/btcpayserver/pull/5748) on [btcpayserver/btcpayserver](https://github.com/btcpayserver/btcpayserver) (1 week ago)
- [Upgraded to latest PS dependencies](https://github.com/btcpayserver/prestashop-plugin/pull/93) on [btcpayserver/prestashop-plugin](https://github.com/btcpayserver/prestashop-plugin) (1 week ago)
- [Update BTCPayServer.Plugins.Blink.csproj](https://github.com/Kukks/BTCPayServerPlugins/pull/27) on [Kukks/BTCPayServerPlugins](https://github.com/Kukks/BTCPayServerPlugins) (2 months ago)
